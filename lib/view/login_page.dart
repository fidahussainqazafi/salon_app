                  ...
                  children: [
                          ...
                          Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                              ...
                              children: [
                                ...
                                const Text("               Forget your password",style: TextStyle(color: Colors.white,fontSize: 15),),
                                const SizedBox(
                                  height: 10,
                                ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Text("if you don't create account ?",style: TextStyle(color: Colors.white,fontSize: 15),),
